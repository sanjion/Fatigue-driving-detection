...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default="/root/autodl-tmp/fatigue/yolov5/weights/yolov5s.pt", help="initial weights path")
    parser.add_argument("--cfg", type=str, default="/root/autodl-tmp/fatigue/yolov5/models/yolov5s copy.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default="/root/autodl-tmp/fatigue/yolov5/data/VOC_copy.yaml", help="dataset.yaml path")
