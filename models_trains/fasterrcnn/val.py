...
def run(
    ...
    if model == None:
        ...
        model = FasterRCNN(backbone, num_classes, min_size=400, max_size=600)  # 81 类（包括背景）
    ...
    # 验证集评估
    model.eval()  # 切换到评估模式
    s = ("%18s" + "%10s" * 4 + "%12s" * 2) % ("Class", "Images", "Instances", "P", "R", "mAP50", "mAP50-95")
    ...
    with torch.no_grad():  # 禁用梯度计算
        ...
        # Print results
        pf = "%18s" + "%10i" * 2 + "%11.3g" * 4  # print format
...
if __name__ == "__main__":
    ...
    batch_size = 16
    save_dir = r"/home/ubuntu/disk2/casual_code_/yolov8/VOCdevkit/ssd1/"
